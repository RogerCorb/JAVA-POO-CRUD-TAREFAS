...
public class MainScreen extends javax.swing.JFrame {
    ProjectController projectController; // Declarando  as variaveis objeto que serão
    TaskController taskController;       // que serão instanciadas lá embaixo
    ...
    private void initComponents() {
        ...
        jPanelEmptyListLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelEmptyListLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelEmptyListSubTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 545, Short.MAX_VALUE)
                .addContainerGap())
        ...
        jLabelTollBarTitle.setFont(new java.awt.Font("Segoe UI", 1, 34)); // NOI18N
        ...
        jPanelToolBarLayout.setVerticalGroup(
            ...
            .addGroup(jPanelToolBarLayout.createSequentialGroup()
                ...
                .addGap(7, 7, 7)
                .addComponent(jLabelToolBarSubTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jLabelProjectsTitle.setBackground(new java.awt.Color(204, 255, 255));
        ...
        jPanelTasksLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelTasksLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelTasksTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTableTasks.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Descrição", "Prazo", "Concluida"
            }
        ) {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPaneTasks, javax.swing.GroupLayout.DEFAULT_SIZE, 573, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPaneTasks, javax.swing.GroupLayout.DEFAULT_SIZE, 537, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jLabelProjectsAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelProjectsAddMouseClicked
        ...
        // Ao clicar em adicionar projetos abrimos uma nova janela
        // de adição de projetos para o usuário
    ...
    private void jLabelTasksAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelTasksAddMouseClicked
        // TODO add your handling code here:
         ...
         // Ao cliclar em adicionar tarefas  abrimos uma nova janela
         // de adição de tarefas para o usuário
    ...
    public void DecorateTableTask(){ // Criamos um método/função DecorationTableTask
        // tipo VAZIO (Void) ou indefinido como queiram
        
        // Moficamos os parâmetros do cabeçalho de nosso grid.
        
        jTableTasks.getTableHeader().setFont(new Font("Segoe UI",Font.BOLD,14));
        jTableTasks.getTableHeader().setBackground(new Color(0,153,102));
        jTableTasks.getTableHeader().setForeground(new Color(255,255,255));
        
        // Criamos um sort (ordenamento) automatico para as colunas do cabeçalho
        jTableTasks.setAutoCreateRowSorter(true);        
       
    } 
    public void initComponetsModel(){ // Criamos um método/função initComponetsModel
        // tipo VAZIO (Void) ou indefinido como queiram
            projectsModel = new DefaultListModel(); // Instanciammos o objeto
            LoadProjects();
            taskModel = new TaskTableModel(); // instaciamos o objeto
            jTableTasks.setModel(taskModel);            
            loadTasks(1); // Estou passando o id do projeto 1 , todas as tarefas 
            // desse projeto devem ser carregadas
    }
    
    public void loadTasks(int idProject){     
        List<Task> tasks = taskController.getAll(idProject); // Carregamos as tarefas do BD tasks
        taskModel.setTasks(tasks); // colocamos dentro do nosso objeto taskModel
    }

    public void LoadProjects() { // Criamos um método/função DecorationTableTask
        // tipo VAZIO (Void) ou indefinido como queiram
